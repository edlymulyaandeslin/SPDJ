            ...
            <div class="mt-20">
                    ...
                    <div class="max-w-screen-xl px-4 py-8 mx-auto sm:py-16 lg:px-6">
                        ...
                        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                            ...
                            @foreach ($penyakits as $penyakit)
                                <div>
                                    <div
                                        class="flex items-center justify-center overflow-hidden w-24 h-20 mb-4 ">
                ...
                <footer class="p-4 bg-gray-700 md:p-8 lg:p-10 dark:bg-gray-800">
                    <div class="max-w-screen-xl mx-auto text-center">
                        ...
                        <span class="text-sm text-gray-400 sm:text-center dark:text-gray-400">Copyright © 2024
                            &bullet; SPDKJ</span>
                    </div>
                </footer>
            </div>
